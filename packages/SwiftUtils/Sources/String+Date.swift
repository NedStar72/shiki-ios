...
public extension String {
  enum DateFormatType {
    ...
    var stringFormat: String {
      switch self {
      // handle iso Time
      case .birthDateFormatOne: "dd/MM/YYYY"
      case .birthDateFormatTwo: "dd-MM-YYYY"
      case .isoYear: "yyyy"
      case .isoYearMonth: "yyyy-MM"
      case .isoDate: "yyyy-MM-dd"
      case .isoDateTime: "yyyy-MM-dd'T'HH:mmZ"
      case .isoDateTimeSec: "yyyy-MM-dd'T'HH:mm:ssZ"
      case .isoDateTimeMilliSec: "yyyy-MM-dd'T'HH:mm:ss.SSSZ"
      case .dotNet: "/Date(%d%f)/"
      case .rss: "EEE, d MMM yyyy HH:mm:ss ZZZ"
      case .altRSS: "d MMM yyyy HH:mm:ss ZZZ"
      case .httpHeader: "EEE, dd MM yyyy HH:mm:ss ZZZ"
      case .standard: "EEE MMM dd HH:mm:ss Z yyyy"
      case let .custom(customFormat): customFormat

      // handle local Time
      case .localDateTimeSec: "yyyy-MM-dd HH:mm:ss"
      case .localTimeWithNoon: "hh:mm a"
      case .localDate: "yyyy-MM-dd"
      case .localPhotoSave: "yyyyMMddHHmmss"
      case .messageRTetriveFormat: "yyyy-MM-dd'T'HH:mm:ssZZZZZ"
      case .emailTimePreview: "dd MMM yyyy, h:mm a"
      }
    }
  }
